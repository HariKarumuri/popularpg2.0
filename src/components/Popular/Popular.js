        ...
        <div className="container">
          ...
          <div className="property-list has-scrollbar row container-custom">
...

            {
              data && data.map((item) => {
                return (
                  <div className="property-card col-lg-4 col-md-5 col-sm-10 col-10" key={item.category_id}>
              ...
              <div className="card-content">
                ...
                <ul className="card-list">
                  <li className="card-item">
                    ...
                    {item.products[0].triple_sharing_price === null ? <span>₹NA</span> : <span>{item.products[0].triple_sharing_price}</span>}
                  ...
                  <li className="card-item">
                    ...
                    {item.products[0].double_sharing_price === null ? <span>₹NA</span> : <span>{item.products[0].double_sharing_price}</span>}
                  ...
                  <li className="card-item">
                    ...
                    {item.products[0].single_sharing_price === null ? <span>₹NA</span> : <span>{item.products[0].single_sharing_price}</span>}
                  </li>
                </ul>
              </div>
